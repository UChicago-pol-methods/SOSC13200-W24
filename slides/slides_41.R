...
if(!dir.exists('figs41')){dir.create('figs41')}
...
## ----plot_basic, fig = FALSE, include = FALSE, echo = FALSE-------------------
if(!file.exists('figs41/-plot_basic.pdf')){
  g <- ggplot(dat, aes(x = year_of_birth, y = education)) +
    geom_point()
  ggsave('figs41/-plot_basic.pdf', g, width = 6, height=6)
}
